...
public class NoteActivity extends AppCompatActivity {
    public static final String NOTE_POSITION = "com.lens.pluralsight.notesappconstraintlayout.NOTE_POSITION";
    ...
    private void displayNote(Spinner spinnerCourses, EditText textNoteTitle, EditText textNoteText) {
        ...
        int courseIndex = courseInfoList.indexOf(mNote.getCourse());
    ...
    private void sendEmail() {
        //implicit intent to let an android app send an email
        CourseInfo courseInfo = (CourseInfo) mSpinnerCourses.getSelectedItem();
        String subject = mTextNoteTitle.getText().toString();
        String text = "Check this out from the pluralsight course \"" +
